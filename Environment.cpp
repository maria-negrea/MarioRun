...
Environment::Environment()
{
	...
	InitializeObstacles(0, road->GetRoadSize());
	InitializeOffRoadObjects(0, road->GetRoadSize());
}
...
{
	InitializeObstacles(road->GetRoadSize()-1, road->GetRoadSize());
